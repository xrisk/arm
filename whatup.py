...
def udharja():
    ...
    print ("x=",round((center[0]-288)*(20/234)),"y=",round((461-center[1])*(20/234)))
    print ("to"+"\n","x=",ex,"y=",why)
    print ("x=",(ex-320)*(20/234),"y=",(480-why)*(20/234))
    axe=round((center[0]-288)*(20/234))
    bhai=round((461-center[1])*(20/234))
    return axe,bhai